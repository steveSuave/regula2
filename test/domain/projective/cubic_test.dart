...
void main() {
  group('solveCubic', () {
    ...
    test('degree drop to quadratic and linear', () {
      ...
      expect(
        solveCubic(Complex.zero, Complex.zero, Complex.zero, cval(1)),
        isEmpty,
      );
    });
    ...
    test('non-finite coefficients yield no roots instead of throwing', () {
      expect(solveCubic(cval(1), cval(double.nan), cval(1), cval(1)), isEmpty);
      expect(
    ...
    Glados3(any.gridComplex, any.gridComplex, any.gridComplex).test(
      'reconstructs grid roots from Vieta coefficients',
      (r1, r2, r3) {
        final c2 = -(r1 + r2 + r3);
  ...
  group('solveQuadratic', () {
    ...
    test('degree drop to linear and constant', () {
      ...
      expect(solveQuadratic(Complex.zero, Complex.zero, Complex.zero), isEmpty);
    });
    ...
    Glados2(any.gridComplex, any.gridComplex).test(
      'reconstructs grid roots from Vieta coefficients',
      (r1, r2) {
